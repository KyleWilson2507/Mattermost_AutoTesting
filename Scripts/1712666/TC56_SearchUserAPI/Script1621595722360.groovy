...
RequestObject searchUserRequest = findTestObject('1712666_API_Mattermost/SearchUserAPI')
...
searchUserRequest.setHttpHeaderProperties(HTTPHeader)

def response = WS.sendRequest(searchUserRequest)

WS.verifyElementPropertyValue(response, "[0].username", "phuc");