...
RequestObject logoutRequest = findTestObject('1712666_API_Mattermost/LogoutAPI')
...
logoutRequest.setHttpHeaderProperties(HTTPHeader)

def response = WS.sendRequest(logoutRequest)
