...
RequestObject searchPublicChannelRequest = findTestObject('1712666_API_Mattermost/SearchPublicChannelAPI')
...
searchPublicChannelRequest.setHttpHeaderProperties(HTTPHeader)

def response = WS.sendRequest(searchPublicChannelRequest)

WS.verifyElementPropertyValue(response, "[0].name", "test1");