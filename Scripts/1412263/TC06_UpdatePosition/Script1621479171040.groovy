...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/button_huykhoi263_style--none sidebar-heade_fefe58'))

WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/button_Account Settings'))

WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_EditPosition'))

WebUI.setText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Position_position'), 'student')
