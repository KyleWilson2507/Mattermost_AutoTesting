...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/button_Security'))

for (def i = 1; i <= 5; i++) {
    WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_EditPassword'))

    WebUI.setEncryptedText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Current Password_currentPassword'), 
        findTestData('1412263/Data TC2 UpdatePassword').getValue(1, i))

    WebUI.setEncryptedText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_New Password_newPassword'), 
        findTestData('1412263/Data TC2 UpdatePassword').getValue(2, i))

    WebUI.setEncryptedText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Retype New Password_confirmPassword'), 
        findTestData('1412263/Data TC2 UpdatePassword').getValue(3, i))

    WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/button_Save'))
