...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_Account Settings'))

for(def i=1; i<=5; i++)
{
	WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_EditNickname'))
	
	WebUI.setText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Nickname_nickname'), findTestData("1412263/Data TC3 UpdateFullName").getValue(2, i))
