...
WebUI.click(findTestObject('Page_Town Square - CNC_Nhom3 Mattermost/span'))
...
for (def i = 1; i <= 5; i++) {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Town Square - CNC_Nhom3 Mattermost/input_Last Name_lastName'), 
