...
WebUI.setText(findTestObject('1412263_Page_Mattermost/input_All team communication in one place, _dcc84b (1)'), 'huykhoi263')
...
for (def i = 1; i <= 5; i++) {
    ...
    WebUI.setEncryptedText(findTestObject('1412263_Page_System Console - Mattermost/input_New Password_form-control'), findTestData(
            '1412263/Data TC8 ResetPassword').getValue(1, i))
