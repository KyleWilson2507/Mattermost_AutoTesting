...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_EditEmail'))

WebUI.setText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_New Email_primaryEmail'), 
    'huykhoiabca@gmail.com')

WebUI.setText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Confirm Email_confirmEmail'), 
    'huykhoiabca@gmail.com')
...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/button_Close'))
