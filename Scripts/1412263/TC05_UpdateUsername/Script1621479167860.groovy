...
WebUI.click(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/span_EditUsername'))

WebUI.setText(findTestObject('1412263_Page_Town Square - CNC_Nhom3 Mattermost/input_Username_username'), 'huykhoi263')
