...
WebUI.click(findTestObject('1612049/DirectMessage_Workspace/btn_Replied Message Button_btnAdd'))

WebUI.click(findTestObject('1612049/DirectMessage_Workspace/btn_Close Comment Button_btnClose'))
