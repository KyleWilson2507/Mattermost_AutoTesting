...
WebUI.click(findTestObject('1612049/Posts_Area/Posts_List/Post_Menu/btn_DeleteMessage'))

WebUI.click(findTestObject('1612049/Posts_Area/Posts_List/DeleteConfirmation_Dialog/btn_ConfirmDelete'))
