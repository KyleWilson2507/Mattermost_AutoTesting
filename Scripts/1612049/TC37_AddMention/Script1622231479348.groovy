...
for (index = 1; index <= 5; index++) {
    WebUI.setText(findTestObject('1612049/Posts_Area/Posts_Create/input_Message'), '@' + findTestData('1612049/Data TC37 AddMention').getValue(
            1, index))

    WebUI.sendKeys(findTestObject('1612049/Posts_Area/Posts_Create/input_Message'), Keys.chord(Keys.ENTER))

    WebUI.verifyTextPresent('@' + findTestData('1612049/Data TC37 AddMention').getValue(1, index), true)
